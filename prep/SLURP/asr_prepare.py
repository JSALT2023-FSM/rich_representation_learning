        ...
        with jsonlines.open(jsonl_path) as reader:
            for obj in reader:
                ...
                for recording in obj["recordings"]:
                    ...
                    asr_model  = EncoderDecoderASR.from_hparams(source="/gpfsstore/rech/nou/uzn19yk/JSALT/rich_speech/pretrained_conformer/asr-conformer-transformerlm-librispeech/", savedir="pretrained_models/asr-transformer-transformerlm-librispeech")
                    asr_model.to(emo_id_brain.device)
                    asr_transcript = asr_model.transcribe_file("path")
                    asr_transcripts.append(asr_transcript)
