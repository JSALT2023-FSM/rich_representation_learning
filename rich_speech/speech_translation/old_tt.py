...
def dataio_prepare(hparams):
    ...
    def reference_text_pipeline(sentence):
        """Processes the transcriptions to generate proper labels"""
        yield sentence
        tokens_list = tokenizer_input.sp.encode_as_ids(sentence)
        sentence_tokens = torch.LongTensor([hparams["bos_index"]] + (tokens_list))
